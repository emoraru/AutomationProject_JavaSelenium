...
public class ElementsPageTests extends BaseTest {
    ...
    public void CheckboxButtonTest() {
        ...
        Assert.assertTrue((WDUtils.getCurrentUrl(driver).equals(URLConstants.CHECKBOX_BUTTON_URL)),
                "Found the following URL: " + WDUtils.getCurrentUrl(driver) + " instead of: " + URLConstants.CHECKBOX_BUTTON_URL);
    }
    ...
    public void ButtonsButtonTest() {
        ...
        WDUtils.waitForSeconds(1);
        Assert.assertTrue((WDUtils.getCurrentUrl(driver).equals(URLConstants.BUTTONS_BUTTON_URL)),
                "Found the following URL: " + WDUtils.getCurrentUrl(driver) + " instead of: " + URLConstants.BUTTONS_BUTTON_URL);
    }
    ...
    public void DoubleClickButtonTest() {
        ...
        WDUtils.waitForSeconds(1);
        Assert.assertTrue(poDoubleClickButton.isDoubleClickActionPerformed(),
                "Unable to verify Double Click action was performed on Double Click Me button");
    }
    ...
    public void RightClickMeButtonTest() {
        ...
        WDUtils.waitForSeconds(1);
        Assert.assertTrue(poRightClickMeButton.isRightClickActionPerformed(),
                "Unable to verify Right Click action was performed on Right Click Me button.");
    }
    ...
    public void TextBoxButtonTest() {
        ...
        WDUtils.waitForSeconds(1);
        Assert.assertTrue(WDUtils.getCurrentUrl(driver).equals(URLConstants.TEXT_BOX_BUTTON_URL),
                "Found the following URL: " + WDUtils.getCurrentUrl(driver) + " instead of: " + URLConstants.TEXT_BOX_BUTTON_URL);
    }
    ...
    public void setTextOnTextFieldTest() {
        ...
        Assert.assertTrue(poTextFields.setTextCurrentAddressField(IdentityDataConstants.CURRENT_ADDRESS),
                "Unable to set text to Current Address field.");
        WDUtils.waitForSeconds(1);
        ...
        Assert.assertTrue(poTextFields.setTextPermanentAddressField(IdentityDataConstants.PERMANENT_ADDRESS),
                "Unable to set text to Permanent Address field.");
        WDUtils.waitForSeconds(1);
