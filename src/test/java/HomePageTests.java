...
public class HomePageTests extends BaseTest {
    ...
    public void openHomePageTest() {
        Assert.assertTrue(WDUtils.getCurrentUrl(driver).contains(URLConstants.BASE_URL), "Found the following URL: " + WDUtils.getCurrentUrl(driver) + " instead of: " + URLConstants.BASE_URL);
    }
    ...
    public void verifyElementsCardButtonTest() {
        ...
        Assert.assertTrue((WDUtils.getCurrentUrl(driver).contains(URLConstants.ELEMENTS_CARD_URL)), "Found the following URL: " + WDUtils.getCurrentUrl(driver) + " instead of: " + URLConstants.ELEMENTS_CARD_URL);
    }
    ...
    public void verifyFormsCardButtonTest() {
        ...
        WDUtils.waitForSeconds(5);
        Assert.assertTrue((WDUtils.getCurrentUrl(driver).contains(URLConstants.FORMS_CARD_URL)), "Found the following URL: " + WDUtils.getCurrentUrl(driver) + " instead of: " + URLConstants.FORMS_CARD_URL);
    }
    ...
    public void verifyAlertsWindowsCardButtonTest() {
        ...
        WDUtils.waitForSeconds(5);
        Assert.assertTrue((WDUtils.getCurrentUrl(driver).contains(URLConstants.ALERTS_WINDOWS_CARD_URL)), "Found the following URL: " + WDUtils.getCurrentUrl(driver) + " instead of: " + URLConstants.ALERTS_WINDOWS_CARD_URL);
    }
    ...
    public void verifyWidgetsCardButtonTest() {
        ...
        WDUtils.waitForSeconds(5);
        Assert.assertTrue((WDUtils.getCurrentUrl(driver).contains(URLConstants.WIDGETS_CARD_URL)), "Found the following URL: " + WDUtils.getCurrentUrl(driver) + " instead of: " + URLConstants.WIDGETS_CARD_URL);
    }
    ...
    public void verifyInteractionsButtonTest() {
        ...
        WDUtils.waitForSeconds(5);
        Assert.assertTrue((WDUtils.getCurrentUrl(driver).contains(URLConstants.INTERACTIONS_CARD_URL)), "Found the following URL: " + WDUtils.getCurrentUrl(driver) + " instead of: " + URLConstants.INTERACTIONS_CARD_URL);
    }
    ...
    public void verifyBooksButtonTest() {
        ...
        WDUtils.waitForSeconds(5);
        Assert.assertTrue((WDUtils.getCurrentUrl(driver).contains(URLConstants.BOOKS_CARD_URL)), "Found the following URL: " + WDUtils.getCurrentUrl(driver) + " instead of: " + URLConstants.BOOKS_CARD_URL);
    }
